...
public class ParameterSphere extends ParameterFunction {
    ...
    ParameterSphere(ArrayList<SphereDot> sphereDots) {
        this.type = "Sphere";
    ...
    ParameterSphere(double[] phi, double[] omega) {
        this.type = "Sphere";
